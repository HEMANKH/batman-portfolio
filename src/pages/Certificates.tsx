...
const certificates = [
  {
    ...
    date: "2023",
    description: "Master-level certification in advanced coding techniques and system architecture",
    verified: true,
  },
  {
    ...
    date: "2023",
    description: "Expert-level certification in cybersecurity and digital forensics",
    verified: true,
  },
  {
    ...
    date: "2022",
    description: "Recognition for outstanding contribution to enterprise technology solutions",
    verified: true,
  },
  {
    ...
    date: "2022",
    description: "Advanced certification in cloud infrastructure and scalable systems",
    verified: true,
  },
  {
    ...
    date: "2021",
    description: "Comprehensive training in artificial intelligence and predictive algorithms",
    verified: true,
  },
];
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="mb-16 text-center animate-fade-in">
          <h1 className="text-6xl font-['Orbitron'] font-black mb-4">
            <span className="text-primary">CREDENTIALS</span> & <span className="hologram-text">HONORS</span>
          </h1>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="glass-card hologram-border p-8 text-center animate-float">
            <div className="text-5xl font-['Orbitron'] font-bold hologram-text mb-2">15+</div>
            <div className="font-['Rajdhani'] text-muted-foreground">Certifications</div>
          </div>
          <div className="glass-card hologram-border p-8 text-center animate-float" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="glass-card hologram-border p-8 text-center animate-float" style={{ animationDelay: '0.4s' }}>
